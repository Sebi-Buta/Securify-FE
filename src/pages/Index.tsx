      ...
      <Card className="border-0 overflow-hidden relative">
        ...
        <CardContent className="p-8 relative">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight mb-3">
            Bine ai venit în Mediul CyberSim
          </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-5">
            ...
            <p className="text-3xl font-bold">3<span className="text-muted-foreground text-lg">/12</span></p>
        ...
        <Card>
          <CardContent className="p-5">
            ...
            <p className="text-3xl font-bold">7 <span className="text-sm font-normal text-muted-foreground">Critice: 2</span></p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-5">
            ...
            <p className="text-3xl font-bold">Novice <span className="text-sm font-normal text-muted-foreground">250 XP</span></p>
          </CardContent>
        </Card>
      </div>
            ...
            {labs.map((lab) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">Dificultate: {lab.difficulty} · {lab.time}</p>
                </div>
