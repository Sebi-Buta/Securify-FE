            ...
            <CardContent className="p-8 flex items-center justify-center min-h-[400px]">
              <div className="w-full max-w-sm">
                <div className="text-center mb-6">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Introduceți credențialele pentru a accesa panoul de administrare.</p>
                </div>
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="email" className="text-sm">Email sau Nume Utilizator</Label>
                    <Input id="email" placeholder="admin@exemplu.com" value={username} onChange={(e) => setUsername(e.target.value)} />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="pass" className="text-sm">Parolă</Label>
                    <div className="relative">
                      <Input id="pass" type={showPassword ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} />
                  ...
                  <p className="text-center text-[11px] text-muted-foreground">Protejat de CyberSim Auth v1.0</p>
                </form>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-3">
                ...
                <p className="text-muted-foreground text-xs leading-relaxed">
                  Când inputul utilizatorului este concatenat direct într-o interogare SQL fără sanitizare, un atacator poate manipula structura interogării.
                </p>
              </div>
              <div>
...
AND password = '$password';`}
              ...
              <div>
                ...
                <ol className="list-decimal list-inside text-xs text-muted-foreground space-y-1">
                  <li>În câmpul de utilizator, încearcă un payload care face condiția mereu adevărată.</li>
                  <li>Payload: <code className="text-primary font-mono">admin' OR '1'='1</code></li>
              ...
              <div className="bg-info/10 border border-info/20 rounded-lg p-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Folosește Interogări Parametrizate (Prepared Statements) în loc de concatenarea șirurilor. Activează modul „Securizat" de mai sus pentru a vedea în acțiune.
                </p>
              </div>
            </CardContent>
          </Card>
